    ...
    public function rules()
    {
        return array_merge(
            ...
            array(
                 ...
                 array('authTemplateSlim, authTemplateHybrid, providers, authTemplate, formOrientation, textEditor, internalModels, backendViewPathAlias, frontendViewPathAlias, messageCatalog,messageCatalogStandard', 'safe'),
            )
        );
    }
