<div class="btn-toolbar">
    <div class="btn-group">
        <?php
        echo '<?php echo CHtml::link("Manage",array("admin"),array("class"=>"btn btn-inverse")); ?>';
        echo '<?php
            switch($this->action->id) {
                ...
                case "view":
                    ...
                    echo CHtml::link("Delete",array("delete"),array("class"=>"btn btn-danger"));
                    break;
                case "update":
...
// render relation links
    ...
    <div class="btn-group">
        <?php echo "<?php if(\$this->action->id == 'admin') echo CHtml::link(Yii::t('app', 'Advanced Search'),'#',array('class'=>'btn search-button')); ?>"; ?>
    </div>
</div>
